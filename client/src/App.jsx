...
export default function TransactionViewer() {
  ...
  // Fetch transactions when category or page changes
  useEffect(() => {
    if (selectedCategory) {
      fetchTransactions();
    }
  ...
  const fetchTransactions = async () => {
    ...
    try {
      const response = await fetch(
        `${API_BASE_URL}/transactions?category=${encodeURIComponent(selectedCategory)}&page=${currentPage}&page_size=${pageSize}`
      );
