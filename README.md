...
python scripts/rbc\_categorizer.py data/your\_export.csv YOUR\_ANTHROPIC\_API\_KEY

```



This creates `your\_export\_categorized.csv` with an added "Category" column.
